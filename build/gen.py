...
<footer class="footer">
  <div class="wrap">
    ...
    <div class="footer__bar">
      ...
      <span><span class="va">Fet i programat amb estima a la muntanya per Juansa Moll</span><span class="es">Hecho y programado con cariño a la montaña por Juansa Moll</span></span>
    </div>
  </div>
</footer>'''
