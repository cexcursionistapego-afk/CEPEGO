...
'''+footer()
    ...
    rules=[("Sols es pot fer foc a la xemeneia de dins del refugi; proporcionem llenya, graelles i material per encendre lliure de tòxics.","Solo se puede hacer fuego en la chimenea del interior; proporcionamos leña, parrillas y material para encender libre de tóxicos."),
     ...
     ("No es pot pujar a la planta superior amb sabates: cal fer-ho descalç.","No se puede subir a la planta superior con zapatos: hay que hacerlo descalzo."),
...
'''
    ...
    routes=[("Circular Figuereta – Tossal","2,97 km","+154 m","673 m","facil","Fàcil","Fácil",
     ...
     ("Les Juvees d'en Mig a Fleix","4,1 km","+326 m","519 m","facil","Fàcil","Fácil",
      "Les Juvees d'en Mig · Riu Girona · Fleix.",
      IMG+"ruta-juvees-fleix-qr.png", "https://es.wikiloc.com/rutas-senderismo/les-juvees-d-enmig-rio-girona-fleix-la-ruta-de-los-6000-escalones-57327116", "Vall d'Ebo"),
  ...
  <div class="wrap">
    <div class="grid cols-2">
      ...
      <div class="card reveal" style="text-align:center;display:flex;flex-direction:column">
        ...
        <p class="lead" style="font-size:1rem;margin-bottom:20px;flex:1"><span class="va">Lamentem veure't marxar. Omple el formulari amb les teues dades i processarem la baixa.</span><span class="es">Lamentamos verte partir. Rellena el formulario con tus datos y procesaremos la baja.</span></p>
