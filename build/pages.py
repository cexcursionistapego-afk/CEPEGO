...
'''
    ...
    routes=[("Circular Figuereta – Tossal","2,97 km","+154 m","673 m","facil","Fàcil","Fácil",
     ...
     ("Les Jovees d'en Mig a Fleix","4,1 km","+326 m","519 m","moderada","Moderada","Moderada",
      "Les Jovees d'en Mig · Riu Girona · Fleix. No és circular: només d'anada, i baixa més del que puja (−390 m), així que cal pensar la tornada.",
