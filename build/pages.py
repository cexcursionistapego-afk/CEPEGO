...
<section class="section-sm" style="padding-bottom:clamp(20px,3vw,32px)">
  <div class="wrap narrow center reveal">
    ...
    <p class="lead"><span class="va">Al calendari veus els dies lliures i els ja reservats. Tria les teues dates, envia la sol·licitud i <strong>nosaltres la revisarem</strong>. Et contactarem per correu electrònic per confirmar-la i indicar-te els passos a seguir. Cal donar-se pressa a seguir-los: només et mantindrem el refugi reservat durant <strong>10 hores</strong> des de la recepció d'eixe correu de confirmació.</span><span class="es">En el calendario ves los días libres y los ya reservados. Elige tus fechas, envía la solicitud y <strong>nosotros la revisaremos</strong>. Te contactaremos por correo electrónico para confirmarla e indicarte los pasos a seguir. Debes darte prisa en seguirlos: solo te mantendremos el refugio reservado durante <strong>10 horas</strong> desde la recepción de ese correo de confirmación.</span></p>
  </div>
</section>
        ...
        <form id="reserva-form" novalidate>
          ...
          <div class="select-row">
            <div class="field"><label><span class="va">Ets soci/a?</span><span class="es">¿Eres soci@?</span> *</label>
              <select name="soci" required><option value="">—</option><option value="Si">Sí</option><option value="No">No</option></select></div>
