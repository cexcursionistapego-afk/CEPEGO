  ...
  <div class="wrap hero__inner">
    <div class="hero__brand">
      ...
      <div class="hero__brand-text">
        <span class="hero__club"><span class="va">Centre Excursionista</span><span class="es">Centro Excursionista</span></span>
        <span class="hero__since"><span class="va">Des de 1973</span><span class="es">Desde 1973</span></span>
      </div>
    </div>
    <h1 class="hero__place-title">PEGO</h1>
    <p><span class="va">Club de muntanya sense ànim de lucre. Senderisme, escalada, barranquisme, espeleologia i alta muntanya des de Pego, Alacant.</span><span class="es">Club de montaña sin ánimo de lucro. Senderismo, escalada, barranquismo, espeleología y alta montaña desde Pego, Alicante.</span></p>
