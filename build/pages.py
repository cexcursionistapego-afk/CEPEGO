  ...
  <div class="wrap">
    <div class="grid cols-2" style="margin-bottom:20px">
      <div class="reveal" style="text-align:center">
        ...
        <p class="lead" style="font-size:1rem;margin:0"><span class="va">Últimes notícies del club.</span><span class="es">Últimas noticias del club.</span></p>
      </div>
      <div class="reveal" style="text-align:center">
        <h2 style="font-size:1.6rem;color:var(--ember)"><span class="va">Reunions</span><span class="es">Reuniones</span></h2>
        <p class="lead" style="font-size:1rem;margin:0"><span class="va">Pròximes reunions de la junta directiva del club.</span><span class="es">Próximas reuniones de la junta directiva del club.</span></p>
      </div>
    </div>
    <div class="grid cols-2">
      <ul class="noticies reveal" id="noticies-list" style="text-align:left"></ul>
      <ul class="reunions reveal" id="reunions-list" style="text-align:left"></ul>
    </div>
  </div>
</section>'''
